    ...
    setup: function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                schema = (0, crypto_1.randomUUID)();
                console.log(generateDatabaseURL(schema));
                process.env.DATABASE_URL = generateDatabaseURL(schema);
                (0, child_process_1.execSync)("npx prisma migrate deploy --preview-feature --schema=".concat(schema));
                return [2 /*return*/, {
                        teardown: function () {
                            return __awaiter(this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, prisma.$executeRawUnsafe("DROP SCHEMA IF EXISTS \"".concat(schema, "\" CASCADE"))];
                                        case 1:
                                            _a.sent();
